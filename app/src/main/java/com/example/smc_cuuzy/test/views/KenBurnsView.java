 ...
 */
package com.example.smc_cuuzy.test.views;
...
import com.example.smc_cuuzy.test.views.kenburn.RandomTransitionGenerator;
import com.example.smc_cuuzy.test.views.kenburn.Transition;
import com.example.smc_cuuzy.test.views.kenburn.TransitionGenerator;
...
public class KenBurnsView extends AppCompatImageView {
    ...
    public void setImageResource(String wallpaper) {
