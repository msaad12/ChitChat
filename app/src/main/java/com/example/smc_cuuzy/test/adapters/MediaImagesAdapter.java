...
public class MediaImagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MediaImagesAdapter(Activity mActivity, List<UsersModel> dataset) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
        return new ContentViewHolder(mInflater.inflate(R.layout.media_images_item, parent, false));
    }
